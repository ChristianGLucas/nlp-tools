...
// every *_test.go file in this package — declare it here ONCE only (each of
// the four `axiom create node` scaffolds generated its own duplicate copy of
// this boilerplate, which will not compile together; this file replaces all
// of them).
...
// testFlowMutation is a no-op mutation sink — none of these nodes mutate the graph.
